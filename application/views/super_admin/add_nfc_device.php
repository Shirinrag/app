...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h4 class="card-title">Add NFC Device</h4>
                                 <?php echo form_open('superadmin/save_nfc_device_data', array('id'=>'add_nfc_device_form')) ?>
                                 <div class="row">
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label>Add Device</label>
                                          <input type="text" class="form-control input-text" name="nfc_device_id" placeholder="Add Device">
                                          <span class="error_msg" id="nfc_device_id_error"></span>
                                       </div>
                                    </div>                                   
                                 </div>
                                   <div class="row">
                     ...
                     <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title">Add NFC Device List</h4>
                              <div class="table-responsive">
                                 <table class="table" id="nfc_device_data_table">
                                    <thead>
                                       <tr>
                                          <th>SR. No</th>
                                          <th>Device Id</th>
               ...
               <div class="modal fade" id="edit_device_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                     <div class="modal-content">
                        ...
                        <?php echo form_open('superadmin/update_nfc_device_data', array('id'=>'update_device_form')) ?>
                        <div class="modal-body">
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Add Device</label>
                                    <input type="text" class="form-control input-text" name="edit_nfc_device" id="edit_nfc_device" placeholder="Add Device">
                                    <span class="error_msg" id="edit_nfc_device_error"></span>
                                 </div>
                              </div>
      ...
      <script type="text/javascript" src="<?=base_url()?>assets/view_js/add_nfc_device.js"></script>
