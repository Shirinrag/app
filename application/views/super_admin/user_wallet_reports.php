...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h4 class="card-title">User Wallet Reports</h4>
                     ...
                     <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title">User Wallet Report List</h4>
                              <div class="table-responsive">
                                <table class="table" id="user_wallet_data_report_table">
                                  <thead>
                                    <tr>
                                      <th>SR. No</th>
                                      <th>Customer Name</th>
      ...
      <script type="text/javascript" src="<?=base_url()?>assets/view_js/user_wallet_report.js"></script>
