                           ...
                           <div class="card">
                              <div class="card-body">
                                 ...
                                 <div class="row">
                                    ...
                                    <div id="register_user_data" style="display: none;">
                                          <div class="col-md-4">
                                             <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                             <div class="form-group">
                                               ...
                                               <select type="text" class="form-control chosen-select-deselect" name="fk_user_id" id="fk_user_id" placeholder="Select Admin Role">
                                                   <option value=""></option>
                                                   <?php 
                                          ...
                                          <div class="col-md-4">
                                             <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control input-text" name="contact_no" placeholder="Description"></textarea>
                                                <span class="error_msg" id="contact_no_error"></span>
                                             </div>
                                          </div>
                                       </div>
