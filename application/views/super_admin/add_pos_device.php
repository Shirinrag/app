...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h4 class="card-title">Add POS Device</h4>
                                 <?php echo form_open('superadmin/save_pos_device_data', array('id'=>'add_pos_device_form')) ?>
                                 <div class="row">
                                    <div class="col-md-4">
                                 ...
                                 <div class="row">
                                  <div id="device_data_append"></div></div>
                                 <div class="row">
                     ...
                     <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title">Add POS Device List</h4>
                              <div class="table-responsive">
                                 <table class="table" id="pos_device_data_table">
                                    <thead>
                                       <tr>
                                          <th>SR. No</th>
                                          <th>Device Id</th>
      ...
      <script type="text/javascript" src="<?=base_url()?>assets/view_js/add_pos_device.js"></script>
