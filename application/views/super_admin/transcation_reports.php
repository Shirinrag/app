...
<html lang="en">
   <head>
      ...
      <title>Transcation Reports</title>
      <!-- plugins:css -->
   ...
   <body>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col">
                           <div class="card">
                              <div class="card-body">
                                 <h4 class="card-title">Transcation Reports</h4>
                     ...
                     <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title">Transcation Data</h4>
                              <div class="table-responsive">
                                <table class="table" id="transcation_data_report_table">
                                  <thead>
                                    <tr>
                                      <th>SR. No</th>
                                      <th>Name</th>
      ...
      <script type="text/javascript" src="<?=base_url()?>assets/view_js/transcation_reports.js"></script>
